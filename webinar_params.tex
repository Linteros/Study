...
\node[font=\scriptsize\bfseries,text=MCRed,fill=white,fill opacity=.9,text opacity=1,inner sep=1.2pt,anchor=east] at (axis cs:4.75,-5.65) {$a=-6$};
\node[font=\scriptsize\bfseries,text=MCRed,fill=white,fill opacity=.9,text opacity=1,inner sep=1.2pt,anchor=east] at (axis cs:4.75,-1.65) {$a=-2$};
\node[font=\scriptsize\bfseries,text=MCRed,fill=white,fill opacity=.9,text opacity=1,inner sep=1.2pt,anchor=east] at (axis cs:4.75,.35) {$a=0$};
\node[font=\scriptsize\bfseries,text=MCRed,fill=white,fill opacity=.9,text opacity=1,inner sep=1.2pt,anchor=east] at (axis cs:4.75,2.35) {$a=2$};
\node[font=\scriptsize\bfseries,text=MCRed,fill=white,fill opacity=.9,text opacity=1,inner sep=1.2pt,anchor=east] at (axis cs:4.75,6.35) {$a=6$};
\end{axis}
\end{tikzpicture}

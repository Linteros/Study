...
\begin{tikzpicture}
\begin{axis}[
  mcaxis,width=.95\textwidth,height=110mm,
...
\addplot[MCRed!62,line width=1pt,domain=-1:7] {-x+1};
\addplot[MCRed!62,line width=1pt,domain=-1:7] {x+1};
\addplot[MCRed!62,line width=1pt,domain=-1:7] {4*x/3+1};
\addplot[MCRed!62,line width=1pt,domain=-1:4.4] {2*x+1};
\addplot[MCRed!62,line width=1pt,domain=-1:1.45] {6*x+1};
...
\addplot[MCAxis!72,dashed,line width=1pt,domain=-4:4] {-x-3};
\foreach \yy in {-6,-2,0,2,6}{\addplot[MCRed!48,line width=.8pt,domain=-4:4] {\yy};}
